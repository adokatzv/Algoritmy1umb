...
int main() {
    ...
    } while (c != 'a' && c != 'n'); // Opakuje, pokiaľ nie je zvolená platná voľba
    ...
    if (c == 'a') {
        ...
        } while (c != 'b' && c != 'a'); // Opakuje, pokiaľ nie je zvolený správny tunel
        ...
        } while (c != 'b' && c != 'c'); // Kontrola pre zánik
                ...
                do {
                    ...
                    if (c == 'a') { // Ak hráč zvolí nebezpečný tunel
                        ...
                        if (hp != 0) {
                            ...
                            printf("Zomrel si"); // Správa o smrti
                            exit(0);
                        }
                    }
                } while (c != 'b'); // Kontrola pre zánik
